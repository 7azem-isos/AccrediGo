...
namespace AccrediGo.Controllers
{
    ...
    public class AuthController : ApiControllerBase
    {
        ...
        public AuthController(IMediator mediator, ICurrentRequest currentRequest, IJwtService jwtService) : base(currentRequest)
        {
            _mediator = mediator;
        ...
        public async Task<IActionResult> Login([FromBody] LoginRequest request)
        {
            try
            {
                ...
                // Use JWT generated by LoginCommandHandler
